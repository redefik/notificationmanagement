...
func setup() {
	...
	courseItem := repository.CourseItem{CourseName: "testcoursesubscription_testdepartment_2018-2019"}
...
// TestCourseDeletionSuccess tests the following scenario: the client correctly add a subscription to the mailing list
// of a course.
